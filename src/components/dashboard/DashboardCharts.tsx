...
const DashboardCharts = ({ orders }: DashboardChartsProps) => {
  ...
  const statusData = [
    { name: "Conciliado", value: orders.filter(o => o.status === "ok").length, color: COLORS.ok },
    { name: "Diferença", value: orders.filter(o => o.status === "difference").length, color: COLORS.difference },
    { name: "A liberar", value: orders.filter(o => o.status === "pending").length, color: COLORS.pending },
    { name: "Retido", value: orders.filter(o => o.status === "retained").length, color: COLORS.retained },
  ];
